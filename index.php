				...
				<div id="statistics">
                    ...
                    <div id="stat_bottom"></div>
                    	...
                    	<div>
                            ...
                            <div class="stat value"><?php $users = mysqli_num_rows(mysqli_query($database->connection, "SELECT * FROM " . TB_PREFIX . "users"));
							echo $users-4; ?></div>
                            <div class="clear"></div>
							<div class="stat type"><?php echo PLAYERS_ACTIVE; ?>:</div>
                            <div class="stat value"><?php $active = mysqli_num_rows(mysqli_query($database->connection,"SELECT * FROM " . TB_PREFIX . "users WHERE " . time() . "-timestamp < (3600*24) AND tribe!=5 AND tribe!=0"));
							echo $active; ?></div>
							<div class="clear"></div>
                            <div class="stat type"><?php echo PLAYERS_ONLINE; ?>:</div>
                            <div class="stat value"><?php $online = mysqli_num_rows(mysqli_query($database->connection,"SELECT * FROM " . TB_PREFIX . "users WHERE " . time() . "-timestamp < (60*5) AND tribe!=5 AND tribe!=0"));
							echo $online; ?></div>
							<div class="clear"></div>
	                	</div>
                	</div>
