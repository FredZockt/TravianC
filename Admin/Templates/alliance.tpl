						...
						<table cellpadding="0" cellspacing="0">
							<tbody>
								...
								<?php
									...
									{
										$player = mysqli_fetch_assoc(mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."users WHERE id = ".$row['uid'].""));
			...
			<thead>
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						$ally = mysqli_fetch_assoc(mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = ".$row['alli2'].""));
						echo '
						<tr>
			...
			<thead>
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						$ally = mysqli_fetch_assoc(mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = ".$row['alli1'].""));
						echo '
						<tr>
			...
			<thead>
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						$ally1 = mysqli_fetch_assoc(mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = ".$row['alli1'].""));
						$ally2 = mysqli_fetch_assoc(mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = ".$row['alli2'].""));
						echo '
						<tr>
