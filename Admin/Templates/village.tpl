			...
			<tbody>
				...
				<?php
					...
					if($isthere >0)
					{
						...
						{
							$oasiswref = $row['wref'];
							$oasisx = mysqli_result(mysqli_query($database->connection, "SELECT x FROM ".TB_PREFIX."wdata WHERE id = ".$oasiswref.""), 0);
							$oasisy = mysqli_result(mysqli_query($database->connection, "SELECT y FROM ".TB_PREFIX."wdata WHERE id = ".$oasiswref.""), 0);
