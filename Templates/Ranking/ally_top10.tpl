<?php
    ...
    $result = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata ORDER BY ap DESC, id ASC Limit 10");
    $result2 = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = '".$session->alliance."' ORDER BY ap DESC, id ASC Limit 1");
...
<?php
    ...
    $result = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata ORDER BY dp DESC, id ASC Limit 10");
    $result2 = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = '".$session->alliance."' ORDER BY dp DESC, id ASC Limit 1");
?>
...
<?php
    ...
    $result = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata ORDER BY clp DESC, id ASC Limit 10");
    $result2 = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = '".$session->alliance."' ORDER BY clp DESC, id ASC Limit 1");
?>
...
<?php
    ...
    $result = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE RR >= 0 ORDER BY RR DESC, id ASC Limit 10");
    $result2 = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."alidata WHERE id = '".$session->alliance."' AND RR >= 0 ORDER BY RR DESC, id ASC Limit 1");
?>
