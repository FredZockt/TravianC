...
$sql = mysqli_query($database->connection, "SELECT * FROM $prefix WHERE owner = $session->uid  AND delowner = 0 ORDER BY time DESC");
...
$sql2 = mysqli_query($database->connection, "SELECT * FROM $prefix WHERE owner = $session->uid AND delowner = 0 ORDER BY time DESC $limit");
$paginationDisplay = "";
