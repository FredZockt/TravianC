...
?>
        ...
        if(mysqli_num_rows(mysqli_query($database->connection, "SELECT * FROM " . TB_PREFIX . "artefacts")) == 0) {
        	...
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 1");
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 2");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 4");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 5");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 6");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 8");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 9");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 7");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = mysqli_query($database->connection, "SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 3");
        	while($row = mysqli_fetch_array($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
