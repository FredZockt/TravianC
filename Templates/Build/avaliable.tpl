...
$query = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."vdata WHERE owner = ".$user."");
while($villaggi_array = mysqli_fetch_array($query)){

	//loop structure village
	$query1 = mysqli_query($database->connection, "SELECT * FROM ".TB_PREFIX."fdata WHERE vref = ".$villaggi_array['wref']."");
