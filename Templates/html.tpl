<html>
	<head>
		...
		<link href="gpack/travian_Travian_4.0_41/lang/ir/compact.css?<?= time(); ?>" rel="stylesheet" type="text/css" />
        <link href="gpack/travian_Travian_4.0_41/lang/ir/lang.css?<?= time(); ?>" rel="stylesheet" type="text/css" />
