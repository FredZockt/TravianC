        ...
        <div id="header">
			...
			<div class=\"bubble-content\">".$unnotice."</div></div>";
                    ...
                    <li id="n6" class="messages">
                        <a class=" active" href="nachrichten.php" accesskey="6" title="<?php echo HEADER_MESSAGES; ?><?php if($message->unread){ echo' ('.count($database->getMessage2($session->uid)).')'; } ?>"></a>
                        <?php
                        if($message->unread) {
                ...
                <div class="contentContainer">
                    <div id="content" class="messages">
                        ...
                        if(isset($_GET['id']) && !isset($_GET['t'])) {
                            ...
                            $database->delMessage($_GET['n1'], $session->uid);
