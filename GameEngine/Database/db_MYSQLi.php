<?php
        ...
        ('$wid', '$uid', '$vname', '$capital', 2, 1, 0, 780, 780, 780, 800, 780, 800, '$time', '$time')";
        		return mysqli_query($this->connection, $q) or die(mysqli_error($this->connection));
        	}
        ...
        return $array;
        	...
        	*****************************************/
            ...
            function delMessage($id, $uid) {
                $q = "DELETE FROM " . TB_PREFIX . "mdata WHERE id = $id AND target = $uid";
                return mysqli_query($this->connection, $q);
            }
          ...
          /*Addon fix header Message*/
			...
			***************************/
        	...
        	function addBuilding($wid, $field, $type, $loop, $time, $master, $level) {
                ...
                mysqli_query($this->connection,$x) or die(mysqli_error($this->connection));
        	...
        	function removeBuilding($d) {
                ...
                if($SameBuildCount > 0) {
                    ...
                    if($jobs[$jobDeleted]['field'] >= 19) {
                        ...
                        $result = mysqli_query($this->connection,$x) or die(mysqli_error($this->connection));
